...
chickenskewer={
:name => 'Suya (Nigerian Chicken Skewers)',
:ingredients => '1 tablespoon garlic powder
...
:picture => 'http://img.food.com/img/recipes/45/54/02/large/picE00DIJ.jpg',
:description => 'delicious Nigerian chicken skewers',
:instructions => '1.Mix all the dry ingredients together.
...
Read more: <a href="http://www.food.com/recipe/suya-nigerian-chicken-skewers-455402?oc=linkback">http://www.food.com/recipe/suya-nigerian-chicken-skewers-455402?oc=linkback</a>',
:user_id => 5
}

recipes = [applepie, chocmousse, stirfry, chickenskewer]
